...
U-Net is a convolutional neural network (CNN) architecture designed for semantic 
            ...
            U-Net is particularly well-suited to this problem because it combines:
            - an **encoder** that extracts high-level visual features (textures, edges, structures),
            - a **decoder** that reconstructs a high-resolution output mask,
            - and **skip connections** that preserve fine spatial details (crucial for building footprints and sharp boundaries). 
            In our case, the network is trained to output a segmentation mask where each pixel represents:
            - **background** (non-building areas), and
            - a **damage class** (No / Minor / Major / Destroyed) for building regions.

            """)


# Placeholder for architecture image
st.image("app/imgs/unet.png", caption="U-Net Architecture Diagram (Example)")
...
st.image("app/imgs/loss.png", caption="Training Loss Curve")
st.image("app/imgs/accuracy.png", caption="Training Accuracy Curve")
st.image("app/imgs/f1_score.png", caption="F1 Score Curve")
...
col1.image("app/imgs/example1.png")
col2.image("app/imgs/example2.png")
col3.image("app/imgs/example3.png")
col4.image("app/imgs/example4.png")
col5.image("app/imgs/example5.png")
